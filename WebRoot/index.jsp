		...
		<div>
			...
			<div style="position: relative;top: 180px;left: 80px;height:500px;">
				<ul class="media-list cus-addr">
					<li class="media cus-addrli"><a href="http://www.ptsso.com" class="pull-left"><img src="style/cust/01.png"
							class="media-object" alt="平通网"></a></li>
			...
			<!-- 爱常用中内容 -->
			<div id="love_common" style="display:none;"></div>
		...
		<div id="sidediv" class="side">
			<ul>
				<li><a href="javascript:void(0);"><div class="sidebox">
							<img src="style/common/img/side_icon01.png">客服中心
						</div></a></li>
				<li><a href="javascript:void(0);"><div class="sidebox">
							<img src="style/common/img/side_icon02.png">客户案例
						</div></a></li>
				<li><a href="javascript:void(0);"><div class="sidebox">
							<img src="style/common/img/side_icon04.png">QQ客服
						</div></a></li>
				<li><a href="javascript:void(0);"><div class="sidebox">
							<img src="style/common/img/side_icon03.png">新浪微博
						</div></a></li>
				<li style="border:none;display: none;" id="sidetop"><a href="javascript:goTop();" class="sidetop"><img
